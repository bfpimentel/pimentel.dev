  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-0 px-2">
      ...
      <main className="flex flex-col px-0 py-4">
        <h1 className="m-3 text-8xl md:text-9xl font-bold">Lu,</h1>
        <div className="flex flex-col m-4">
          ...
          <h3 className="text-3xl mt-2 mb-3">Qual a sua qualidade que eu mais admiro e gostaria de ter?</h3>
          <p>
          ...
          <h3 className="text-3xl mt-2 mb-3">No que eu acho que você poderia se esforçar mais na nossa relação?</h3>
          <p>
          ...
          <h3 className="text-3xl mt-2 mb-3">Te amo, meu anjo.</h3>
          <p>
